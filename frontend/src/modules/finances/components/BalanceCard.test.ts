...
describe('BalanceCard — slim card states', () => {
  ...
  it('shows "X owes you" direction text for positive balance', () => {
    const wrapper = mount(BalanceCard, {
      props: { balance: makeBalance(1000), otherMember: makeMember({ display_name: 'Bob' }), currency: 'EUR' },
    })
  ...
  it('shows "All settled" direction text for zero balance', () => {
    const wrapper = mount(BalanceCard, {
      props: { balance: makeBalance(0), otherMember: makeMember({ display_name: 'Bob' }), currency: 'EUR' },
    })
  ...
  it('renders member name in slim-name', () => {
    const wrapper = mount(BalanceCard, {
      props: { balance: makeBalance(1000), otherMember: makeMember({ display_name: 'Alice' }), currency: 'EUR' },
    })
