...
test('oauth2 callback: unregistered user sees not-registered message on /auth', async ({ page }) => {
...
test('oauth2 callback: new user on an instance with no household is redirected to /setup', async ({ page }) => {
...
test('/auth?error=not_registered loaded directly shows message and sign-in form', async ({ page }) => {
